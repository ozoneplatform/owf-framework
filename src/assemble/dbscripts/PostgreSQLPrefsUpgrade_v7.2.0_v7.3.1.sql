...
-- Ran at: 11/25/13 4:29 PM

-- Liquibase version: 2.0.1
-- *********************************************************************

-- Lock Database
-- Changeset changelog_7.3.1.groovy::7.3.1-0::owf::(Checksum: 3:45f52094ad67d4066c6a42d4fdf9230e)
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Fixing Postgres id columns to have id generators', NOW(), 'Custom SQL (x11)', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-0', '2.0.1', '3:45f52094ad67d4066c6a42d4fdf9230e', 1);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Add type to dashboard', NOW(), 'Add Column', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-1', '2.0.1', '3:da90c894252394662881278c5011df4f', 2);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', '', NOW(), 'Create Table', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-3', '2.0.1', '3:85d934f83517b58484131edbd73d1252', 4);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Add icon image url to dashboard', NOW(), 'Add Column', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-5', '2.0.1', '3:ebf4c6cfc522e45a5efc657a72cc6b8d', 6);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', '', NOW(), 'Add Column, Create Index, Add Foreign Key Constraint', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-7', '2.0.1', '3:e50b259c6a288dbdafc06dcd1ef34c37', 8);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', '', NOW(), 'Add Default Value', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-17', '2.0.1', '3:cc301f6f6f73cf363fe77c5e28604b25', 12);
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, version) VALUES ('owf.cef.sweep.log.location', 'AUDITING', TRUE, NULL, 3, ' ', 'Boolean', 'true', 0);
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, version) VALUES ('owf.enable.cef.log.sweep', 'AUDITING', TRUE, NULL, 5, ' ', 'String', '/var/log/cef', 0);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', '', NOW(), 'Insert Row (x20)', 'EXECUTED', 'app_config_7.3.1.groovy', 'app_config-7.3.1-1', '2.0.1', '3:b6de99e7893c65e875383c4167711771', 13);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Add isApproved to stack', NOW(), 'Add Column', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-18', '2.0.1', '3:e20a0daf3c5203f6a4aa2df0b27d0673', 14);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Create Administrator''s App and its default group.', NOW(), 'Insert Row (x3)', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-21', '2.0.1', '3:8c5356773157ee7fa260d2d83900cba5', 15);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Add Administration App to the OWF Administrators group.', NOW(), 'Insert Row', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-22', '2.0.1', '3:5fdc73b48e8adc3314e2644e28a3f072', 16);
...
INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'App Component Editor', 440, 'themes/common/images/adm-tools/Widgets64.png', 'themes/common/images/adm-tools/Widgets24.png', FALSE, 'org.ozoneplatform.owf.admin.appcomponentedit', 0, FALSE, '679294b3-ccc3-4ace-a061-e3f27ed86451', 'admin/WidgetEdit.gsp', '1.0', 581);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'App Components', 440, 'themes/common/images/adm-tools/Widgets64.png', 'themes/common/images/adm-tools/Widgets24.png', FALSE, 'org.ozoneplatform.owf.admin.appcomponentmanagement', 0, TRUE, '48edfe94-4291-4991-a648-c19a903a663b', 'admin/WidgetManagement.gsp', '1.0', 818);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Group Editor', 440, 'themes/common/images/adm-tools/Groups64.png', 'themes/common/images/adm-tools/Groups24.png', FALSE, 'org.ozoneplatform.owf.admin.groupedit', 0, FALSE, 'dc5c2062-aaa8-452b-897f-60b4b55ab564', 'admin/GroupEdit.gsp', '1.0', 581);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Groups', 440, 'themes/common/images/adm-tools/Groups64.png', 'themes/common/images/adm-tools/Groups24.png', FALSE, 'org.ozoneplatform.owf.admin.groupmanagement', 0, TRUE, '53a2a879-442c-4012-9215-a17604dedff7', 'admin/GroupManagement.gsp', '1.0', 818);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'User Editor', 440, 'themes/common/images/adm-tools/Users64.png', 'themes/common/images/adm-tools/Users24.png', FALSE, 'org.ozoneplatform.owf.admin.useredit', 0, FALSE, 'a9bf8e71-692d-44e3-a465-5337ce5e725e', 'admin/UserEdit.gsp', '1.0', 581);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Users', 440, 'themes/common/images/adm-tools/Users64.png', 'themes/common/images/adm-tools/Users24.png', FALSE, 'org.ozoneplatform.owf.admin.usermanagement', 0, TRUE, '38070c45-5f6a-4460-810c-6e3496495ec4', 'admin/UserManagement.gsp', '1.0', 818);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Configuration', 440, 'themes/common/images/adm-tools/Configuration64.png', 'themes/common/images/adm-tools/Configuration24.png', FALSE, 'org.ozoneplatform.owf.admin.configuration', 0, TRUE, 'af180bfc-3924-4111-93de-ad6e9bfc060e', 'admin/Configuration.gsp', '1.0', 900);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'App Editor', 440, 'themes/common/images/adm-tools/Stacks64.png', 'themes/common/images/adm-tools/Stacks24.png', FALSE, 'org.ozoneplatform.owf.admin.appedit', 0, FALSE, '72c382a3-89e7-4abf-94db-18db7779e1df', 'admin/StackEdit.gsp', '1.0', 581);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Apps', 440, 'themes/common/images/adm-tools/Stacks64.png', 'themes/common/images/adm-tools/Stacks24.png', FALSE, 'org.ozoneplatform.owf.admin.appmanagement', 0, TRUE, '391dd2af-a207-41a3-8e51-2b20ec3e7241', 'admin/StackManagement.gsp', '1.0', 818);

INSERT INTO widget_definition (background, display_name, height, image_url_large, image_url_small, singleton, universal_name, version, visible, widget_guid, widget_url, widget_version, width) VALUES (FALSE, 'Page Editor', 440, 'themes/common/images/adm-tools/Dashboards64.png', 'themes/common/images/adm-tools/Dashboards24.png', FALSE, 'org.ozoneplatform.owf.admin.pageedit', 0, FALSE, '2445afb9-eb3f-4b79-acf8-6b12180921c3', 'admin/DashboardEdit.gsp', '1.0', 581);
...
INSERT INTO databasechangelog (AUTHOR, COMMENTS, DATEEXECUTED, DESCRIPTION, EXECTYPE, FILENAME, ID, LIQUIBASE, MD5SUM, ORDEREXECUTED) VALUES ('owf', 'Remove the old admin widgets.', NOW(), 'Delete Data (x4)', 'EXECUTED', 'changelog_7.3.1.groovy', '7.3.1-31', '2.0.1', '3:923bc0f0a83220ac48a155d89e8d1c1c', 21);
