...
Ozone.layout.tooltipString = {
	...
	addWidgetsContent: 				'This button opens or closes the Favorites Menu, allowing users to add widgets to their current page.',
	dashboardSwitcherTitle:			'My Apps',
	...
	adminWDDeleteContent: 			'Deletes the selected widget definition. In addition to removing the definition itself, all instances of this widget will be removed from all user pages.',
	...
	adminDashCopyContent: 			'Copy an existing page to one or more users. Note that once copied, each page instance is an independent entity. Changes made to the initial pages at a later date will not be copied.',
...
Ozone.layout.DialogMessages = {
    ...
    marketplaceWindow_LaunchSuccessful: 'The widget was added successfully from Marketplace. Now choose the page where you want the widget to launch. It must be different from the current page.',
    ...
    dashboardLockWarning: 'Locking this page disables the Launch Menu. New widgets cannot be launched or added to this layout. Do you still want to lock this page?',
    dashboardLockAlertTitle: 'Locked Page',
    dashboardLockAlert: 'This page is locked. Widgets cannot be added or removed from a locked page.',
    ...
    launchWidgetAlert: 'Choose the page where the widget will open.'
};
