...
Ozone.layout.DialogMessages = {
	...
	marketplaceWindow_AddWidget: 'An error occurred while attempting to add the App Component from AppsMall.',
	marketplaceWindow_currentUser: 'Could not retrieve current user name and id.',
    marketplaceWindow_AddSuccessful: 'The App Component was added successfully from AppsMall.',
    marketplaceWindow_WebappLaunchSuccessful: 'The web app was added successfully from AppsMall.',
