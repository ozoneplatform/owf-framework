Ext.define('Ozone.components.dashboard.Dashboard', {
    ...
    initComponent: function() {
        ...
        me.on('afterlayout', me.afterDashboardLayout, me, { single: true });
    ...
    moveWidgetToPane: function(evt, sourcePane, targetPane, widget) {
        ...
        function move () {
            ...
            widget.on('destroy', function () {
                me.launchWidgets(pane, null, {x: x, y: y}, {widgetModel: widgetStateModelData});
            });
            widget.destroy();
        }
    ...
    */
    ...
    getJson: function() {
        ...
        json.state = [];
        json.defaultSettings = this.defaultSettings;
        json.showLaunchMenu = this.showLaunchMenu;
        json = Ext.clone(json);
