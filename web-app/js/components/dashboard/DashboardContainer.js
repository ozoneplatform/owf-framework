...
//                    || (!!Ozone.config.marketplaceLocation)
    ...
    initLoad: function() {
        ...
        var setupInitialDash = Ext.bind(function() {
            ...
            if (this.activeDashboard.showLaunchMenu) {
                this.getBanner().openLaunchMenu();
            }
    ...
    showWidgetSwitcher: function() {
        ...
        widgetSwitcher.show();
        widgetSwitcher.dashboard = this.activeDashboard;
    ...
    createDashboardConfig: function(dashRecord) {
        ...
        return {
            ...
            showLaunchMenu: dash.showLaunchMenu ? dash.showLaunchMenu : false,
            widgetStore: this.widgetStore,
