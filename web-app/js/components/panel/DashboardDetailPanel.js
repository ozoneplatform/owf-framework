    ...
    tpl: new Ext.XTemplate(
            '<tpl for=".">',
                '<div id="detail-info" class="detail-info">',
                    ...
                    '<div class="detail-block">',
                        '<div><span class="detail-label">Owner:</span> {user.userId:htmlEncode}</div>',
            ...
            '</tpl>',
            {
                ...
                renderDetailHeaderBlock: function(values){
                    ...
                    retVal += '<div class="detail-label">by:<span class="dashboard-created-by-label">' + Ext.htmlEncode(createdByName) + '</span></div>';
                    retVal += '</div>';
