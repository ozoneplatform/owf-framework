      ...
      columns: [
        ...
        },
        {
          ...
          renderer:  function(value, metaData, record, rowIndex, columnIndex, store, view) {
            ...
            var retVal = '<div class="grid-widget-title-box"><div class="grid-widget-icon"><img class="grid-widget-icon-image" src="' + Ext.String.htmlEncode(url) + '">';
            retVal += '</div>';
            retVal += '<div class="grid-widget-title">' + Ext.String.htmlEncode(title) + '</div>';
        ...
        },
        {
          ...
          sortable: true,
          renderer:  function(value, metaData, record, rowIndex, columnIndex, store, view) {
            return  '<div class="grid-text">' + Ext.String.htmlEncode(value) +'</div>';
          }
        },
        {
          itemId: 'type',
