						...
						fn: function(cmp) {
							cmp.tip = Ext.create('Ext.tip.ToolTip', {
								...
								renderTo: cmp.ownerCt.el,
                                                                width: 115,
								html: this.dashboardDesigner.locked ? "Dashboard locked" : "Dashboard unlocked",
								listeners: {	
									beforeshow: {
										fn: function updateTipBody(tip) {
											var text = this.dashboardDesigner.locked ? "Dashboard locked" : "Dashboard unlocked";
											tip.update(text);
										},
										scope: this
									}
