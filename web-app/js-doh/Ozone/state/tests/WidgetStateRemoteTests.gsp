...
<head>
    ...
    <script type="text/javascript">
        ...
        dojo.provide("Ozone.eventing.tests.WidgetStateRemoteTests");
        ...
        dojo.addOnLoad(function() {
            ...
            var widget = {
                ...
                url: window.location.protocol + "//" + (altHostName + port +"/"
                        ...
                        +'/js-doh/Ozone/state/tests/testWidgetStateConstructorWithOutEventingController_Widget.gsp').replace(/\/{2,}/,'/')
            };
            ...
            doh.register("Ozone.eventing.tests.WidgetStateRemoteTests", [
                {
                    name: "testWidgetStateConstructorWithOutEventingController",
                    setUp: function() {
