<html>
<head>
    <title>Eventing pubSubRemote Tests</title>
    ...
    <script type="text/javascript">
        ...
        dojo.provide("Ozone.eventing.tests.rpcRemoteTestsHTML");
        ...
        dojo.addOnLoad(function() {
            ...
            doh.register("Ozone.eventing.tests.pubSubRemoteTests", [
                {
...
<body>
<h>Eventing pubSubRemote Tests</h>
