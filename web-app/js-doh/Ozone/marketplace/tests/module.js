dojo.provide("Ozone.marketplace.tests.module");
...
//	dojo.require("Ozone.eventing.tests.widgets.DemoWidget");
    ...
    if(dojo.isBrowser){
        ...
        doh.registerUrl("Ozone.marketplace.tests.AllMarketplaceTests",
                      dojo.moduleUrl("Ozone", "marketplace/tests/AllMarketplaceTests.html"));
    }
}catch(e){
	doh.debug(e);
}