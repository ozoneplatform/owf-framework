  ...
  * @singleton
  * @static
  * @desc This plugin provides an alternate mechanism for hiding Ext.core.Elements and a new hideMode for Ext.Components.<br />
...
(function(){
    ...
    var El = Ext.core.Element, A = Ext.lib.Anim, supr = El.prototype;
	...
	fx.El = {
	 ...
	 //Add basic capabilities to the Ext.core.Element.Flyweight class
	Ext.override(El.Flyweight, fx.El);

    Ext.define('Ext.ux.plugin.VisibilityMode', {
        extend: 'Object',
        alias: 'plugin.uxvismode',
        ...
        init: function(c){
            ...
            var hideMode = this.hideMode || c.hideMode, plugin = this, bubble = Ext.Container.prototype.bubble, changeVis = function(){
            ...
            c.on('render', function(){
                ...
                if (plugin.bubble !== false && this.ownerCt) {
                    ...
                    bubble.call(this.ownerCt, function(){
                        this.visFixed ||
                        this.on('afterlayout', changeVis, this, {
                            single: true
                        });
                    });
                }
        ...
        /**
         * @param {Element/Array} el The Ext.core.Element (or Array of Elements) to extend visibilityCls handling to.
         * @param {String} visibilityCls The className to apply to the Element when hidden.
         * @return this
         */
        extend: function(el, visibilityCls){
            el &&
            Ext.each([].concat(el), function(e){
            
                if (e && e.dom) {
                    if ('visibilityCls' in e) 
                        return; //already applied or defined?
                    Ext.apply(e, fx.El);
