 ...
 * <pre><code>
 * var ddTextArea = new Ext.ux.form.DDTextArea ({
 *   id: 'textarea',
...
/**
 * Creates a new DDTriggerField.
 * @class Ext.ux.form.DDTriggerField Implementation of a drag and drop enabled TriggerField.
 * @augments Ext.form.TriggerField
 * @constructor
 * @param {object} config The configuration to use for the DDTriggerField. 
 * @see Ext.form.TriggerField
 */
Ext.ux.form.DDTriggerField = function (config)
{
	Ext.ux.form.DDTriggerField.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDTriggerField.superclass;
}
Ext.extend (Ext.ux.form.DDTriggerField, Ext.form.TriggerField, {
...
Ext.reg ('ddtrigger', Ext.ux.form.DDTriggerField);