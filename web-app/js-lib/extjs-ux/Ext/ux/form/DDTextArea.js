...
/**
 * Creates a new DDTextArea.
 * @class Ext.ux.form.DDTextArea Implementation of a drag and drop enabled TextArea.
 * @augments Ext.form.TextArea
 * @constructor
 * @param {object} config The configuration to use for the DDTextArea. 
 * @see Ext.form.TextArea
 */
Ext.ux.form.DDTextArea = function (config)
{
	Ext.ux.form.DDTextArea.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDTextArea.superclass;
}
Ext.extend (Ext.ux.form.DDTextArea, Ext.form.TextArea, {
...
Ext.reg ('ddtextarea', Ext.ux.form.DDTextArea);