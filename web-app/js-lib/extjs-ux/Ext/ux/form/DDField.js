 ...
 * <pre><code>
var ddField = new Ext.ux.form.DDField ({
  id: 'field',
  fieldLabel: 'Field',
  listeners: {
...
/**
 * Creates a new DDField.
 * @class Ext.ux.form.DDField Implementation of a drag-and-drop form field.
 * @constructor
 * @augments Ext.form.Field
 * @param {object} config The configuration to use for the DDField. 
 * @see Ext.form.Field
 */
Ext.ux.form.DDField = function (config)
{
	Ext.ux.form.DDField.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDField.superclass;
}
Ext.extend (Ext.ux.form.DDField, Ext.form.Field, {
...
Ext.reg ('ddfield', Ext.ux.form.DDField);