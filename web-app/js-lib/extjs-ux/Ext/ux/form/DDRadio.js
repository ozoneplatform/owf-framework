 ...
 * <pre><code>
 * var ddRadio = new Ext.ux.form.DDRadio ({
 *   id: 'radio',
 *   fieldLabel: 'Radio',
 *   listeners: {
...
/**
 * Creates a new DDRadio.
 * @class Ext.ux.form.DDRadio Implementation of a drag and drop enable Radio button.
 * @augments Ext.form.Radio
 * @constructor
 * @param {object} config The configuration to use for the DDRadio. 
 * @see Ext.form.Radio
 */
Ext.ux.form.DDRadio = function (config)
{
	Ext.ux.form.DDRadio.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDRadio.superclass;
}
Ext.extend (Ext.ux.form.DDRadio, Ext.form.Radio, {
...
Ext.reg ('ddradio', Ext.ux.form.DDRadio);