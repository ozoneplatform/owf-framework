 ...
 * <pre><code>
 * var ddTextField = new Ext.ux.form.DDTextField ({
 *   id: 'textfield',
...
/**
 * Creates a new DDTextField.
 * @class Ext.ux.form.DDTextField Implementation of a drag and drop enabled TextField.
 * @augments Ext.form.TextField
 * @constructor
 * @param {object} config The configuration to use for the DDTextField. 
 * @see Ext.form.TextField
 */
Ext.ux.form.DDTextField = function (config)
{
	Ext.ux.form.DDTextField.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDTextField.superclass;
}
Ext.extend (Ext.ux.form.DDTextField, Ext.form.TextField, {
...
Ext.reg ('ddtextfield', Ext.ux.form.DDTextField);