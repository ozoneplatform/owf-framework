 ...
 * <pre><code>
 * var ddDateField = new Ext.ux.form.DDDateField ({
 *   id: 'datefield',
...
/**
 * Creates a new DDDateField.
 * @class Ext.ux.form.DDDateField Implementation of a drag and drop enabled DateField.
 * @augments Ext.form.DateField
 * @constructor
 * @param {object} config The configuration to use for the DDDateField. 
 * @see Ext.form.DateField
 */
Ext.ux.form.DDDateField = function (config)
{
	Ext.ux.form.DDDateField.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDDateField.superclass;
}
Ext.extend (Ext.ux.form.DDDateField, Ext.form.DateField, {
...
Ext.reg ('dddatefield', Ext.ux.form.DDDateField);