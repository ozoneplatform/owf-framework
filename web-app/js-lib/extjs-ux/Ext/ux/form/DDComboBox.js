 ...
 * <pre><code>
 * var ddComboBox = new Ext.ux.form.DDComboBox ({
 *   id: 'combobox',
...
/**
 * Creates a new DDComboBox.
 * @class Ext.ux.form.DDComboBox Implementation of a drag and drop enabled ComboBox.
 * @augments Ext.form.ComboBox
 * @constructor
 * @param {object} config The configuration to use for the DDComboBox. 
 * @see Ext.form.ComboBox
 */
Ext.ux.form.DDComboBox = function (config)
{
	Ext.ux.form.DDComboBox.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDComboBox.superclass;
}
Ext.extend (Ext.ux.form.DDComboBox, Ext.form.ComboBox, {
...
Ext.reg ('ddcombo', Ext.ux.form.DDComboBox);