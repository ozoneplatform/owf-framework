 ...
 * <pre><code>
 * var ddCheckbox = new Ext.ux.form.DDCheckbox ({
 *   id: 'checkbox',
 *   fieldLabel: 'Checkbox',
 *   listeners: {
...
/**
 * Creates a new DDCheckbox.
 * @class Ext.ux.form.DDCheckbox Implementation of a drag and drop enabled Checkbox.
 * @augments Ext.form.Checkbox
 * @constructor
 * @param {object} config The configuration to use for the DDCheckbox. 
 * @see Ext.form.Checkbox
 */
Ext.ux.form.DDCheckbox = function (config)
{
	Ext.ux.form.DDCheckbox.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDCheckbox.superclass;
}
Ext.extend (Ext.ux.form.DDCheckbox, Ext.form.Checkbox, {
...
Ext.reg ('ddcheckbox', Ext.ux.form.DDCheckbox);