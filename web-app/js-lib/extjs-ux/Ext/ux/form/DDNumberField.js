 ...
 * <pre><code>
 * var ddNumberField = new Ext.ux.form.DDNumberField ({
 *   id: 'numberfield',
...
/**
 * Creates a new DDNumberField.
 * @class Ext.ux.form.NumberField Implementation of a drag and drop enabled Number Field.
 * @augments Ext.form.NumberField
 * @constructor
 * @param {object} config The configuration to use for the DDNumberField. 
 * @see Ext.form.NumberField
 */
Ext.ux.form.DDNumberField = function (config)
{
	Ext.ux.form.DDNumberField.superclass.constructor.call (this, Ext.apply (config));
	this.superclass = Ext.ux.form.DDNumberField.superclass;
}
Ext.extend (Ext.ux.form.DDNumberField, Ext.form.NumberField, {
...
Ext.reg ('ddnumberfield', Ext.ux.form.DDNumberField);