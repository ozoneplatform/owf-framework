 ...
 *
 * 10/16/2013 selectPosition patched to provide correct positioning of drop-down when a container is specified. Tested
 * for a fixed position modal window.
 */
        ...
        selectPosition: function() {
            var _this = this,
                ...
                getPlacement = function($element) {
                    ...
                    // Patch to correctly determine position in a modal window
                    if(typeof _this.options.container !== 'undefined' && _this.options.container !== null && _this.options.container !== 'body' )   {
                        fixedOffset = $(_this.options.container).offset();
                    }

                    $drop.css({
                        'top' : pos.top + actualHeight - Math.ceil(fixedOffset.top),
                        'left' : pos.left - Math.ceil(fixedOffset.left),
