...
(function($) {
	...
	// Added global stack variable to store changes between all notifications
	// Before, the variable created was only local and therefore getting destroyed after the notification
	// was finished being created
	var stack = null;
		...
		pnotify: function(options) {
			...
			pnotify.pnotify_position = function(dont_skip_hidden){
				...
				if (!hidden || dont_skip_hidden) {
					...
					if ((stack.dir1 == "down" && stack.nextpos1 + pnotify.height() > jwindow.height()) ||
						(stack.dir1 == "up" && stack.nextpos1 + pnotify.height() > jwindow.height()) ||
						(stack.dir1 == "left" && stack.nextpos1 + pnotify.width() > jwindow.width()) ||
						(stack.dir1 == "right" && stack.nextpos1 + pnotify.width() > jwindow.width()) ) {
						// If it is, it needs to go back to the first pos1, and over on pos2.
						stack.nextpos1 = stack.firstpos1;
						stack.nextpos2 += stack.addpos2 + (typeof stack.spacing2 == "undefined" ? 25 : s.spacing2);
						stack.addpos2 = 0;
					}
					...
					if (stack.animation && stack.nextpos2 < curpos2) {
						...
						pnotify.css(csspos2, stack.nextpos2+"px");
					// Keep track of the widest/tallest notice in the column/row, so we can push the next column/row.
					switch (stack.dir2) {
						case "down":
						case "up":
							if (pnotify.outerHeight(true) > stack.addpos2)
								stack.addpos2 = pnotify.height();
							break;
						case "left":
						case "right":
							if (pnotify.outerWidth(true) > stack.addpos2)
								stack.addpos2 = pnotify.width();
							break;
					}
					...
					if (stack.nextpos1) {
						...
						if (stack.animation && (curpos1 > stack.nextpos1 || animate.top || animate.bottom || animate.right || animate.left)) {
							...
							pnotify.css(csspos1, stack.nextpos1+"px");
					}
					// Run the animation.
					...
					switch (stack.dir1) {
						case "down":
						case "up":
							stack.nextpos1 += pnotify.height() + (typeof stack.spacing1 == "undefined" ? 25 : stack.spacing1);
							break;
						case "left":
						case "right":
							stack.nextpos1 += pnotify.width() + (typeof stack.spacing1 == "undefined" ? 25 : stack.spacing1);
							break;
					}
				}
			};
