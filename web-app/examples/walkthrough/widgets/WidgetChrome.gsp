...
<html>
<head>
	<link href="../../../themes/a_default.theme/css/a_default.css" rel="stylesheet" type="text/css">
						...
						buttons: [
							{
								...
								toggleHandler: function(btn, state) {
									var cmp = Ext.getCmp('widgetChrome-example');
									var icon = './themes/common/images/shared/warning.gif';
									if (state) {
