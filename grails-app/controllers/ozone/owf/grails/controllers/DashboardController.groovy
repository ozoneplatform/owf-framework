            ...
            if (params.data != null) {
                ...
                if (params.update_action != null && params.update_action != '') {
                    ...
                    dashboards.each {
                        ...
                        args['name'] = it.name
                        args['guid'] = it.guid
                        args['layout'] = it.layout
                        args['columnCount'] = it.columnCount
                        ...
                        //is field could be null or json null if there are no defaultSettings
						args['defaultSettings'] = it.defaultSettings != null && it.defaultSettings != "" && !JSONObject.NULL.equals(it.defaultSettings) ? it.defaultSettings : null
						args['showLaunchMenu'] = it.showLaunchMenu
						
                        args['layoutConfig'] = it.layoutConfig?.toString();
                        args['intentConfig'] = it.intentConfig?.toString();

                        //state needs to be an encoded json string
                        args['state'] = it.state != null && it.state != "" && !it.isNull('state') ? (it.state as JSON).toString() : null
