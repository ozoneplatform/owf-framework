...
class StackControllerTests extends OWFGroovyTestCase {
    ...
    protected void setUp() {
        ...
        def theStack
        theStack = ozone.owf.grails.domain.Stack.build(name: 'Stack One', description: 'Stack One description', stackContext: 'one', imageUrl: 'http://www.images.com/theimage.png', descriptorUrl: 'http://www.descriptors.com/thedescriptor')
        theStack = ozone.owf.grails.domain.Stack.build(name: 'Stack Two', description: 'Stack Two description', stackContext: 'two', imageUrl: 'http://www.images.com/theimage.png', descriptorUrl: 'http://www.descriptors.com/thedescriptor')
        stackId = theStack.id
    }
