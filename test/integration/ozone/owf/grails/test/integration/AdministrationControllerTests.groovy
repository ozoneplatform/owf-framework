...
class AdministrationControllerTests extends OWFGroovyTestCase {
    ...
    void testCopyDashboardNameDuplicatesForCurrentUser() {		
        ...
        def person = Person.build(username:'testAdmin1')
        def dashboard = Dashboard.build(name:'dashboard1', guid:'12345678-1234-1234-1234-1234567890a0', user:person, state:new TreeSet())
    ...
    void testCopySameDashboardNameForDifferentUser() {
        ...
        loginAsUsernameAndRole('testAdmin1', ERoleAuthority.ROLE_ADMIN.strVal)
        def person1 = Person.build(username:'testAdmin1')
        def dashboard = Dashboard.build(name:'dashboard1', guid:'12345678-1234-1234-1234-1234567890a0', user:person1, state:new TreeSet())
    ...
    void testListDashboards() {
        ...
        Dashboard.build(name:'dashboard1', dashboardPosition: 0, guid:'12345678-1234-1234-1234-1234567890a1', user:person1, state:new TreeSet())
        Dashboard.build(name:'dashboard2', dashboardPosition: 1, guid:'12345678-1234-1234-1234-1234567890a2', user:person1, state:new TreeSet())
        Dashboard.build(name:'dashboard3', dashboardPosition: 2, guid:'12345678-1234-1234-1234-1234567890a3', user:person1, state:new TreeSet())
    ...
    void testListDashboardsByGuidParams() {
        ...
        Dashboard.build(name:'dashboard1', guid:'12345678-1234-1234-1234-1234567890a1', user:person1, state:new TreeSet())
        Dashboard.build(name:'dashboard2', guid:'12345678-1234-1234-1234-1234567890a2', user:person1, state:new TreeSet())
        Dashboard.build(name:'dashboard3', guid:'12345678-1234-1234-1234-1234567890a3', user:person1, state:new TreeSet())
    ...
    void testListDashboardsByIsDefaultParams() {
        ...
        Dashboard.build(name:'dashboard1', guid:'12345678-1234-1234-1234-1234567890a1', user:person1, state:new TreeSet(), isdefault:false)
        Dashboard.build(name:'dashboard2', guid:'12345678-1234-1234-1234-1234567890a2', user:person1, state:new TreeSet(), isdefault:false)
        Dashboard.build(name:'dashboard3', guid:'12345678-1234-1234-1234-1234567890a3', user:person1, state:new TreeSet(), isdefault:false)
    ...
    void testListDashboardsByLayoutParams() {
        loginAsUsernameAndRole('testAdmin1', ERoleAuthority.ROLE_ADMIN.strVal)
        def person1 = Person.build(username:'testAdmin1')	
		
        Dashboard.build(name:'dashboard1', guid:'12345678-1234-1234-1234-1234567890a1', user:person1, state:new TreeSet(), layout:'portal')
        Dashboard.build(name:'dashboard2', guid:'12345678-1234-1234-1234-1234567890a2', user:person1, state:new TreeSet(), layout:'desktop')
        Dashboard.build(name:'dashboard3', guid:'12345678-1234-1234-1234-1234567890a3', user:person1, state:new TreeSet(), layout:'portal')
        ...
        assertEquals 'dashboard1', JSON.parse(controller.response.contentAsString).rows[0].name
        assertEquals 'dashboard3', JSON.parse(controller.response.contentAsString).rows[1].name		
    }
