...
class WidgetDefinitionServiceTests extends GroovyTestCase {
    ...
    void testExport() {
        ...
        def exportedFile = widgetDefinitionService.export([id: widget.widgetGuid, filename: "test"])

        assertEquals 'class java.io.File', exportedFile.getClass().toString()
        assertTrue exportedFile.text.contains('"displayName": "' + widget.displayName + '"')
        assertTrue exportedFile.text.contains('"universalName": "' + widget.universalName + '"')
        assertTrue exportedFile.text.contains('"widgetUrl": "' + widget.widgetUrl + '"')
        assertTrue exportedFile.text.contains('"imageUrlLarge": "' + widget.imageUrlLarge + '"')
        assertTrue exportedFile.text.contains('"imageUrlSmall": "' + widget.imageUrlSmall + '"')
        assertTrue exportedFile.text.contains('"description": "' + widget.description + '"')
        assertTrue exportedFile.text.contains('"widgetVersion": "' + widget.widgetVersion + '"')
        assertTrue exportedFile.text.contains('"defaultTags": ["' + tag + '"]')
        assertTrue exportedFile.text.contains('"widgetTypes": ["' + standardWidgetType.name + '"]')
        assertTrue exportedFile.text.contains('"height": ' + widget.height)
        assertTrue exportedFile.text.contains('"width": ' + widget.width)
        assertTrue exportedFile.text.contains('"visible": ' + widget.visible)
        assertTrue exportedFile.text.contains('"background": ' + widget.background)
        assertTrue exportedFile.text.contains('"singleton": ' + widget.singleton)
        assertTrue exportedFile.text.contains('"intents":')
        assertTrue exportedFile.text.contains('"send":')
        assertTrue exportedFile.text.contains('"receive":')
    }
