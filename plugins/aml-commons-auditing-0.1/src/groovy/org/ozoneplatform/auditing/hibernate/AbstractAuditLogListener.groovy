...
abstract class AbstractAuditLogListener implements PostDeleteEventListener, PostInsertEventListener, PostUpdateEventListener, LoadEventListener {
	...
	public void onLoad(LoadEvent event, LoadType type) {
		...
		try{
			if(doCefLogging() && doCefObjectAccessLogging()){
				...
				CEF cef = CEFFactory.buildBaseCEF(EventTypes.OBJ_ACCESS.getDescription(),
	...
	public void onPostUpdate(PostUpdateEvent event) {
		...
		try{
			if(doCefLogging()){
				CEF cef = CEFFactory.buildBaseCEF(EventTypes.OBJ_MODIFY.getDescription(),
	...
	public void onPostInsert(PostInsertEvent event) {
		...
		try{
			if(doCefLogging()){
				...
				CEF cef = CEFFactory.buildBaseCEF(EventTypes.OBJ_CREATE.getDescription(),
	...
	public void onPostDelete(PostDeleteEvent event) {
		...
		try{
			if(doCefLogging()) {
				...
				CEF cef = CEFFactory.buildBaseCEF(EventTypes.OBJ_DELETE.getDescription(),
